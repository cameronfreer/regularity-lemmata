...
fibres are the parts), arXiv:1712.09305, §1.3; `FiniteRelModel.quotient` below is that lemma's
target structure and the tuple-of-cells map its witness. Both are recorded in `PROVENANCE.md`.
