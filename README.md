...
[`lean-toolchain`](https://github.com/cameronfreer/regularity-lemmata/blob/v0.11.0/lean-toolchain)
and the mathlib revision in its
[`lake-manifest.json`](https://github.com/cameronfreer/regularity-lemmata/blob/v0.11.0/lake-manifest.json).
...
on every commit and checked against the v0.11.0 release: a matrix with entries in `[-1, 1]` is
